      ...
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        ...
        <Slide transition={["fade"]} bgColor="primary">
          ...
          <List>
            ...
            <ListItem textSize={'2rem'}>Practice ~4 hours</ListItem>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <Text size={6}>On each render, React tries to limit the amount of changes to the DOM</Text>
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <Text>A way to pass data from an upper to a lower one, without
            having to do it through each children of the hierarchy</Text>
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="primary" textColor="secondary">
          ...
          <CodePane
            lang="jsx"
            source={require("raw-loader!./children")}
            margin="20px auto"
          />
        </Slide>
